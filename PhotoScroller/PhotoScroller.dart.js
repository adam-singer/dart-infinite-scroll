...
HashMapImplementation_dart_core_String$dart_core_String.prototype.clear$0 = HashMapImplementation_dart_core_String$dart_core_String.prototype.clear;
...
$dynamic("get$outerHeight").DOMWindow = function() { return this.outerHeight; };
$dynamic("get$scrollY").DOMWindow = function() { return this.scrollY; };
...
_DOMWindowCrossFrameImpl.prototype.postMessage$3 = _DOMWindowCrossFrameImpl.prototype.postMessage;
...
WindowWrappingImplementation.prototype.get$outerHeight = function() {
  return this._ptr.get$outerHeight();
}
WindowWrappingImplementation.prototype.get$scrollY = function() {
  return this._ptr.get$scrollY();
}
...
XMLDocumentWrappingImplementation.prototype.get$rect = function() {
  return this.documentEl.get$rect();
}
XMLDocumentWrappingImplementation.prototype.get$classes = function() {
  return this.documentEl.get$classes();
}
...
// ********** Code for _XMLClassSet **************
$inherits(_XMLClassSet, _CssClassSet);
function _XMLClassSet(element) {
  _CssClassSet.call(this, element);
}
_XMLClassSet.prototype._className = function() {
  var classStr = this._htmlimpl_element.getAttribute("class");
  return $eq$(classStr) ? "" : classStr;
}
_XMLClassSet.prototype._write = function(s) {
  return this._htmlimpl_element.setAttribute("class", this._formatSet(s));
}
...
XMLElementWrappingImplementation.prototype.get$classes = function() {
  if (null == this._cssClassSet) {
    this._cssClassSet = new _XMLClassSet(this._ptr);
  }
  return this._cssClassSet;
}
...
XMLElementWrappingImplementation.prototype.get$rect = function() {
  return _createMeasurementFuture((function () {
    return const$0011;
  })
  , new CompleterImpl_ElementRect());
...
Observable.first = function(source) {
...
_ChainableIObservableImplementation.prototype.first = function() {
  return Observable.first(this);
}
...
// ********** Code for top level **************
//  ********** Library PhotoScroller **************
// ********** Code for PhotoScroller **************
function PhotoScroller() {
  this.dummyImage = "dummyImage.png";
}
PhotoScroller.prototype.loadImage = function(imageLoc) {
  this.container.get$nodes().add(ElementWrappingImplementation.ElementWrappingImplementation$html$factory(("<a href='" + imageLoc + "'><img src='" + imageLoc + "'/></a>")));
}
PhotoScroller.prototype.get$loadImage = function() {
  return this.loadImage.bind(this);
}
PhotoScroller.prototype.run = function() {
  var $this = this; // closure support
  this.createContainer();
  this.dummyList = [this.dummyImage, this.dummyImage, this.dummyImage, this.dummyImage, this.dummyImage, this.dummyImage, this.dummyImage, this.dummyImage, this.dummyImage, this.dummyImage, this.dummyImage, this.dummyImage];
  ...
  this.scrollObservable.subscribe$1((function (e) {
    $this.container.get$rect().then((function (rect) {
      ...
      if (html_get$$window().get$outerHeight() < html_get$$window().get$scrollY()) {
        $this.scrollToTop.get$style().set$top(html_get$$window().get$outerHeight() / (2));
      }
      else {
        $this.scrollToTop.get$style().set$top(-html_get$$window().get$outerHeight() / (2));
      }
...
PhotoScroller.prototype.createContainer = function() {
  this.container = ElementWrappingImplementation.ElementWrappingImplementation$html$factory("<div id='container'></div>");
  html_get$$document().get$body().get$nodes().add(this.container);
  this.scrollToTop = ElementWrappingImplementation.ElementWrappingImplementation$html$factory("<a id=\"scrollToTop\" href=\"#\" class=\"scrollToTop\"><strong>Scroll to Top</strong><span></span></a>");
  html_get$$document().get$body().get$nodes().add(this.scrollToTop);
  this.scrollToTop.get$style().set$top(-html_get$$window().get$outerHeight() / (2));
  this.scrollToTop.get$classes().add("transitionScrollToTop");
}
// ********** Code for top level **************
function main() {
...
(function(){
  ...
  var table = [
    ...
    , ['SVGTextContentElement', v2/*SVGTextContentElement*/]
    , ['Element', v5/*Element*/]
